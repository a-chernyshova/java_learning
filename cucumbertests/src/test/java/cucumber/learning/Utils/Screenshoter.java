package cucumber.learning.Utils;
...
public class Screenshoter {
    ...
    public static void takeScreenshot(){
        ...
        try {
            ...
            learning.page_object.utils.Logger.info("Saved screenshot: " + screenshotName);
        }catch (Exception e) {
            learning.page_object.utils.Logger.error("Failed to take screenshot");
        }
    }
}